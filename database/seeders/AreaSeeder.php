...
class AreaSeeder extends Seeder
{
    ...
    {
        $comite       = Area::create(['nombre' => 'Comité de Riesgo',        'area_padre_id' => null]); // Lucia

        $gerAdmin     = Area::create(['nombre' => 'Gerencia Administración',  'area_padre_id' => $comite->id]); // Canela
        $gerProd      = Area::create(['nombre' => 'Gerencia Producción',      'area_padre_id' => $comite->id]); // Grassi
